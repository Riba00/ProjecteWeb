                    ...
                    <nav class="relative mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6"
                        ...
                        <div class="flex flex-1 items-center">
                            ...
                            <div class="hidden space-x-8 md:ml-10 md:flex">
                                <a href="#" class="text-base font-medium text-white hover:text-gray-300">Clients</a>

                                <a href="#" class="text-base font-medium text-white hover:text-gray-300">Empreses</a>
                            </div>
                        </div>
                            ...
                            <div class="hidden md:flex md:items-center md:space-x-6">
                                @auth
                                    <a href="{{ url('/dashboard') }}"
                                       class="text-base font-medium text-white hover:text-gray-300">Dashboard</a>
                                @else
                                    <a href="{{ route('login') }}"
                                       class="text-base font-medium text-white hover:text-gray-300">Entra</a>
                                    @if(Route::has('register'))
                                        <a href="{{ route('register') }}"
                                           class="inline-flex items-center rounded-md border border-transparent bg-gray-600 px-4 py-2 text-base font-medium text-white hover:bg-gray-700">Registra't</a>
                                    @endif
                                @endauth
                            </div>
                        @endif
                    ...
                    <div class="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
                        ...
                        <div class="pt-5 pb-6">
                            <div class="space-y-1 px-2">
                                <a href="#"
                                   class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">Clients</a>

                                <a href="#"
                                   class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50">Empreses</a>
                            </div>
                            <div class="mt-6 px-5">
                                <a href="#"
                            ...
                            <div class="mt-6 px-5">
                                <p class="text-center text-base font-medium text-gray-500">Existing customer? <a
                                        href="{{ route('login') }}" class="text-gray-900 hover:underline">Login</a></p>
                                <p class="text-center text-base font-medium text-gray-500">New customer? <a
                                        href="{{ route('register') }}"
                                        class="text-gray-900 hover:underline">Register</a></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-gray-50" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-md px-4 pt-12 sm:max-w-7xl sm:px-6 lg:px-8 lg:pt-16">
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8 xl:col-span-1">
                    ...
                    <div class="flex space-x-6">
                        <a href="https://www.facebook.com/profile.php?id=100089323600626&is_tour_completed=true" class="text-gray-400 hover:text-gray-500">
                        ...
                        <a href="https://twitter.com/UlldEcommerce" class="text-gray-400 hover:text-gray-500">
                        ...
                        <a href="https://github.com/Riba00/ProjecteWeb" class="text-gray-400 hover:text-gray-500">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div class="mt-12 md:mt-0">
                            ...
                            <ul role="list" class="mt-4 space-y-4">
                                ...
                                <li>
                                    <a href="{{ route('policy') }}"
                                       class="text-base text-gray-500 hover:text-gray-900">Politica de Provacitat</a>
                                </li>

                                <li>
                                    <a href="{{ route('terms') }}"
                                       class="text-base text-gray-500 hover:text-gray-900">Condicions de Servei</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="mt-12 border-t border-gray-200 py-8">
                <p class="text-base text-gray-400 xl:text-center">&copy; 2023 JRiba SL. Totes els drets reservats.</p>
            </div>
        </div>
    </footer>
    </body>
